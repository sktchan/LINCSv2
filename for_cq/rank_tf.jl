using DataFrames, Dates, StatsBase, JLD2, Dates
...
# untrt and trt
data_path = "lincs_trt_untrt_data.jld2"
save_path_base = "trt"
...
const additional_notes = "demo run 1ep with rorqual interactive"
...
save_dir = joinpath(save_path_base, "rank_tf", timestamp)
mkpath(save_dir)
